  ...
  const courseData = [
    {
      ...
      description: "Become a full-stack developer by learning HTML, CSS, JavaScript, Node.js, and React.",
      ...
      syllabus: [
        {
          ...
          content: "Overview of HTML, CSS, and JavaScript. Setting up the development environment."
        },
        {
          week: 2,
          topic: "Advanced JavaScript and DOM Manipulation",
          content: "Deep dive into JavaScript, the DOM, and how to make websites interactive."
        }
      ]
    },
    {
      ...
      syllabus: [
        {
          ...
          content: "Getting started with Python programming and setting up the environment."
        },
        {
          week: 2,
          topic: "Data Analysis with Pandas",
          content: "Exploring data using the Pandas library and basic data manipulation."
        }
      ]
    },
    {
      ...
      description: "Understand the core concepts of digital marketing, including SEO, SEM, and social media strategy.",
      enrollmentStatus: "Open",
      thumbnail: "your.image.here",
      duration: "8 weeks",
      ...
      syllabus: [
        {
          ...
          content: "Overview of digital marketing strategies and online platforms."
        },
        {
          week: 2,
          topic: "SEO Basics",
          content: "Understanding search engine optimization and how to improve website visibility."
        }
      ]
    },
    {
      ...
      description: "Master the basics of cloud computing and AWS services for deploying and managing cloud applications.",
      ...
      syllabus: [
        ...
        },
        {
          ...
          content: "Understanding Elastic Compute Cloud (EC2) and Simple Storage Service (S3)."
        }
      ]
    },
    {
      ...
      description: "Learn the principles of user interface and user experience design, and how to create engaging, user-friendly websites and apps.",
      enrollmentStatus: "In Progress",
      thumbnail: "your.image.here",
      duration: "8 weeks",
      schedule: "Wednesdays and Fridays, 4:00 PM-6:00 PM",
      location: "Online",
      prerequisites: ["Basic Knowledge of Design Tools (e.g., Figma, Adobe XD)"],
      syllabus: [
        {
          week: 1,
          topic: "Introduction to UI/UX Design",
          content: "Exploring the basics of UI and UX design and understanding the design process."
        },
        {
          week: 2,
          topic: "Designing with Figma",
          content: "Hands-on practice with creating wireframes and mockups using Figma."
        }
      ]
    }
  ];
            ...
            {courses
              ...
              .map((course) => (
               <div className='flex ' >
                 <div
                  key={course.id}
                  className="p-4 w-1/4   bg-gray-100 rounded cursor-pointer"
        ...
        <div>
          ...
          <div className="p-4 bg-gray-100 rounded">
            ...
            <details className="mt-4">
              <summary className="cursor-pointer text-blue-500">Syllabus</summary>
            ...
            >
              {enrolledCourses.includes(selectedCourse) ? 'Enrolled' : 'Enroll Now'}
            </button>
          </div>
        </div>
      )}
